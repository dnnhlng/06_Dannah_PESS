<?php
	...
	$sql = "SELECT patrolcar.patrolcar_id," .
		"patrolcar_status.patrolcar_status_desc " .
		"FROM patrolcar " .
		"JOIN patrolcar_status ON " .
		"patrolcar.patrolcar_status_id " .
		"=patrolcar_status.patrolcar_status_id";
	...
	if ($btnDispatchClicked == true)
	{
		...
		$sql = "INSERT INTO incident
				...
				incident_type_id, incident_location,
				incident_desc, incident_status_id)
				VALUES('" . $callerName . "',
						'" . $contactNo . "',
						'" . $incidentType . "',
						'" . $location . "',
		...
		for($i=0; $i < $numOfPatrolcarDispatched; $i++)
		{
			...
			$sql = "UPDATE patrolcar SET
				patrolcar_status_id='1'
				...
				$sql = "INSERT INTO dispatch (incident_id,
						patrolcar_id,
						time_dispatched)
	...
	<body>
		<div class="container" style="width: 930px">
				...
				<form action="dispatch.php" method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input name="descriptionOfIncident" id="descriptionOfIncident"
							type="hidden"
							value="<?php echo $descriptionOfIncident; ?>"
						</div>
					</div>
					<div class="form-group row">
						<label for="patrolCars" class="col-sm-4 col-form-label">
							Choose Patrol Car(s)
						</label>
						<div class="col-sm-8">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8" style="text-align:center">
							<div>
								<input class="btn btn-primary" name="btnDispatch"
								type="submit" value="Dispatch">
							</div>
						</div>
					</div>
				</form>
			...
			<footer class="page-footer font-small
						blue pt=4 footer-copyright text-center py-3">
					© 2020 Copyright:
					<a href="https://www.ite.edu.sg">ITE
					</a>
			</footer>
		</div>
